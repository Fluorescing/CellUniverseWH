...
def main():
    ...
    results = []
    if args.angle:
        results.append(["Angle Check"] + checkJSON(test, expected, args.checkLevel, angleFilename))
    if args.colony:
        results.append(["Colony Check"] + checkJSON(test, expected, args.checkLevel, colonyFilename))
    if args.pie:
        results.append(["Pie Check"] + checkSVG(test, expected, args.checkLevel, pieFilename))
    if args.tree:
        results.append(["Tree Check"] + checkSVG(test, expected, args.checkLevel, treeFilename))
